...
=======
    ...
    document.getElementById("utilisation").textContent =
        utilisation.toFixed(1) + "%";

    document.getElementById("minimumPayments").textContent =
        "£" + totalMinimumPayments.toFixed(2);

    const utilisationCard =
        document.getElementById("utilisation").parentElement;

    utilisationCard.classList.remove(
        "util-green",
        "util-amber",
        "util-red"
    );
